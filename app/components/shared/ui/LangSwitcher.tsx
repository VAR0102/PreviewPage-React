...
const styles = {
  container: "flex p-2 gap-2 rounded-full border border-white bg-white/65 shrink-0 cursor-pointer font-[18px]",
  button: "px-4 py-2 rounded-full text-lg transition-all flex items-center gap-2 cursor-pointer",
  gradient: {
